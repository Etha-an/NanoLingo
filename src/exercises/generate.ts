...
import { allItems, displayChars, getItem, primaryLabel, similarChars, type StudyItem } from '../data';
...
/**
 * File d'exercices d'une leçon : découverte de chaque item, puis deux passes
 * de QCM (reconnaissance puis production), puis tracé des items traçables.
 */
...
/**
 * File de révision : pour chaque item dû, un QCM (sens aléatoire) ; les items
 * mûrs (intervalle > 7 j) et traçables sont tracés SANS silhouette.
 */
